<footer class="bg-blue-500 relative bottom-0  w-full py-4">
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <div class="text-center  text-white dark:text-gray-200 pt-10 sm:pt-12 font-bold flex items-center justify-center hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
            Created by Zolmine
        </div>
    </div>

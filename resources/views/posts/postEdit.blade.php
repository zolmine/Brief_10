<div>
    <div id="editModal" class="hidden h-screen w-screen bg-blue-300 bg-opacity-30 fixed z-10 inset-0 overflow-y-auto flex mx-auto px-10 items-center justify-center mb-4">
        <form action="posts/edit" method="post"  class="bg-blue-500 w-full max-w-xl fixed z-4  rounded-lg px-4 pt-2">
            @csrf
